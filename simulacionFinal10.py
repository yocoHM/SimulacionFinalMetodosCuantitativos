...
def simulacionCheckin (tamanioColaCheckIn, llegadasCheckIn, servicioMomentoCheckIn, horaEntrada, diaEntrada):
  ...
  global clientesAtendidosCheckIn
    ...
    if (colaCheckIn[it].tipoDeCuarto == 1):
      ...
      while ((not saved) and i < habitacionesIndividualesTotales):
        ...
        if(habitaciones[i].Ocupante.tipoDeCuarto == 0):
          ...
          habitacionesIndividualesOcupadas += 1
...
def main():
  ...
  # #Resultados totales
  # print("----------------------------------- Resultados totales por área ------------------------------------------")
  # print("Ganancias Totales por CheckIn: $",gananciasTotalesPorCheckIn)
  # print("Ganancia promedio por día por CheckIn: $",(gananciasTotalesPorCheckIn/diasSimulados))
  # print("Ganancias Totales por Spa: $",gananciasTotalesSpa)
  # print("Ganancia promedio por día por Spa: $",(gananciasTotalesSpa/diasSimulados))
  # print("Ganancias Totales por Lavandería: $",gananciasTotalesLavanderia)
  # print("Ganancia promedio por día por Lavandería: $",(gananciasTotalesLavanderia/diasSimulados))
  # print("Ganancias Totales por Restaurante: $",gananciasTotalesRestaurante)
  # print("Ganancia promedio por dia por Restaurante: $",(gananciasTotalesRestaurante/diasSimulados))
  # print("----------------------------------- Resultados totales por área ------------------------------------------")
